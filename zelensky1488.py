...
# фонова музика
mixer.init()
mixer.music.load('musicaca.mp3')
mixer.music.play()
fire_sound = mixer.Sound('artem.mp3')
...
img_back = "Flag_of_Israel.png"  # фон гри
img_hero = "zelensky.png"  # герой
img_bullet = "Picsart_23-09-11_17-12-17-750.png" # куля
img_enemy = "evrei.png"  # ворог
